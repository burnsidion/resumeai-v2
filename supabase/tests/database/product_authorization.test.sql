...
values
  ...
  (
    ...
    'owner-two.pdf',
    '00000000-0000-4000-8000-000000000002/10000000-0000-4000-8000-000000000002.pdf',
    200,
    repeat('b', 64),
    1
  );
...
select lives_ok(
  $$
    ...
    values (
      ...
      '00000000-0000-4000-8000-000000000001',
      'second-owned.pdf',
      '00000000-0000-4000-8000-000000000001/10000000-0000-4000-8000-000000000010.pdf',
      500,
      repeat('6', 64),
      2
    )
