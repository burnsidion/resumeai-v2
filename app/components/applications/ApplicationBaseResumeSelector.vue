...
<template>
  <fieldset
    ...
    class="bg-surface border-line rounded-2xl border p-5 disabled:cursor-wait disabled:opacity-65 sm:p-6"
  >
    ...
    <p :id="descriptionId" class="text-muted mt-1 text-xs leading-5">
    ...
    <div class="mt-4 grid gap-2.5">
      <label
        ...
        :class="
          modelValue === null ? 'border-accent/50 bg-accent/[0.065]' : undefined
        "
      >
        <input
          ref="firstOption"
    ...
    <div :id="statusId" class="mt-3 min-h-5 text-xs leading-5">
      ...
      <div
        ...
        role="alert"
      >
        <p class="text-foreground font-medium">Base resumes are unavailable.</p>
